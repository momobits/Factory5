...
This document is the canonical system reference. Per-decision rationale lives in [`decisions/`](decisions) (32 ADRs). Data shapes live in [`CONTRACTS.md`](CONTRACTS.md). For the operator-facing view of how to drive factory5 — the four canonical loops, when to use which surface, how to author a `CLAUDE.md` spec — see [`WORKFLOWS.md`](WORKFLOWS.md).
...
| [`decisions/`](decisions)            | 32 ADRs + INDEX                                                                                                                 |
